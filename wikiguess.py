...
def edit(links):
    print()
    print("Type in a word to delete it. Say 'Iterate through all' to iterate through every word.")
    print("Say slice[<start>:<end>] to slice the bank. Say 'I am done' to quit")
    print()
    done = False
    toRemove=[]
    while (not done):
